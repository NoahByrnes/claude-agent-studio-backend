...
export const template = Template()
  ...
  .runCmd('mkdir -p /root/.claude/plugins')
  .runCmd('cd /root/.claude/plugins && git clone https://github.com/thedotmack/claude-mem.git || true')
  .runCmd('cd /root/.claude/plugins/claude-mem && npm install || true')
  .runCmd('mkdir -p /root/.claude-mem')
